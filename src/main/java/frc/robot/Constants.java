...
public final class Constants {
   ...
   //DIO
    ...
    public static final int INTAKE_INDEXER         = 2; 
    ...
    public static final int INTAKE_CONVEYOR        = 10; // This Motor 
    public static final int INTAKE                 = 11; //INTAKE THAT TAKES THE POWER CELLS UP TO THE SHOOTER
    ...
    public final static Gains kGains_MotProf = new Gains( 6.0, 0.0,  20.0, .075,  400,  .75 );
    ...
    //shooter
    public static int SETPOINT = 9000;
